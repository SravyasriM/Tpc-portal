...
<body class="hold-transition login-page bg-purple-100 text-white">
  ...
  <div class="login-box content:centre">
    <div class="login-logo">
      <a href="index.php" style="color:blue"><b>Placement Portal</b></a>
    </div>
    <!-- /.login-logo -->
    <div class=" login-box-body bg-orange-200 text-black text-xl">
      <p class="text-blue text-2xl login-box-msg text-black">Placement Cell</p>
